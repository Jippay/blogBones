...
class __TwigTemplate_d77e0da6cc02e5f314b151475656f58ad04f540113be04b7f499ed88c811f5b8 extends \MailPoetVendor\Twig\Template
{
...
<input type=\"text\" disabled=\"disabled\" value=\"\" placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" />";
    ...
    {
        return new Source("", "form/templates/blocks/text.hbs", "C:\\laragon\\www\\JipayGrasseBones\\wp-content\\plugins\\mailpoet\\views\\form\\templates\\blocks\\text.hbs");
    }
}
