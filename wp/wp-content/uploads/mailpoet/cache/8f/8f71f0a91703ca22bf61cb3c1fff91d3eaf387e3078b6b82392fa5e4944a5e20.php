...
class __TwigTemplate_f7da312dc068309b417da627467e8f719f8451e07778290172645d784d7a8d8e extends \MailPoetVendor\Twig\Template
{
  ...
  <textarea placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" disabled=\"disabled\" rows=\"{{#if params.lines}}{{ params.lines }}{{else}}1{{/if}}\">{{ params.text }}</textarea>
    ...
    {
        return new Source("", "form/templates/blocks/textarea.hbs", "C:\\laragon\\www\\JipayGrasseBones\\wp-content\\plugins\\mailpoet\\views\\form\\templates\\blocks\\textarea.hbs");
    }
}
